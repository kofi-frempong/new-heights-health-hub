...
export const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      "The CDC recommends most adults receive their annual flu shot by the end of October. If you're managing a chronic condition, our pharmacists can help you time your vaccine so it doesn't clash with other treatments.",
